...
export default function Header() {
  return (
    <header id="home" className="header">
      ...
      <img src="/public/Background.jpg" alt="Background" className="header-bg" />
      ...
      <div className="header-container">
        ...
        <div className="institution-logos-container">
          <div className="institution-logos">
            <a href="https://www.uece.br/" target="_blank" rel="noopener noreferrer">
              <img src="/public/logo_uece.png" alt="UECE" className="inst-logo" />
            </a>
            <a href="https://gesaduece.com.br/pt" target="_blank" rel="noopener noreferrer">
              <img src="/public/logo_gesad.png" alt="GESAD" className="inst-logo" />
            </a>
          </div>
        </div>
        ...
        <div className="hero-section">
          <div className="logo-section">
            <img src="/public/logo_fabrica-removebg-preview.png" alt="Fábrica de Testadores" className="main-logo" />
          </div>
