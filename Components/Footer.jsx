              ...
              <div className="partners-list">
                <div className="partner-item">
                  <a href="https://www.great.ufc.br/" target="_blank" rel="noopener noreferrer">
                    <img src="/public/great.png" alt="GREat" className="partner-logo" />
                  </a>
                </div>
                <div className="partner-item">
                  <a href="http://rsi.dc.ufc.br/" target="_blank" rel="noopener noreferrer">
                    <img src="/public/Residencia.png" alt="Residência em Segurança da Informação" className="partner-logo" />
                  </a>
                </div>
                <div className="partner-item">
                  <a href="https://www.uece.br/proplan/detic/" target="_blank" rel="noopener noreferrer">
                    <img src="/public/detic.png" alt="DETIC" className="partner-logo" />
                  </a>
                </div>
                <div className="partner-item">
                  <a href="https://www.uece.br/proex/" target="_blank" rel="noopener noreferrer">
                    <img src="/public/PROEX.png" alt="PROEX" className="partner-logo" />
                  </a>
                </div>
              </div>
            </div>
