        ...
        <div className="team-container">
          ...
          <div className="coordinator-card">
            <div className="member-photo coordinator-photo">
              <img src="/public/ismayle.jpg" alt="Ismayle Santos" />
            </div>
            <div className="member-info">
              ...
              <div className="member-social">
                ...
                <a href="http://lattes.cnpq.br/4278565937358466" target="_blank" rel="noopener noreferrer" className="social-link lattes">
                  <img src="/public/Lattes.png" alt="Lattes" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="carousel-container" ref={containerRef}>
            ...
            <div className="member-card">
              <div className="member-photo">
                <img src="/public/wallison.jpg" alt="Wallison" />
              </div>
              <div className="member-info">
            ...
            <div className="member-card">
              <div className="member-photo">
                <img src="/public/pedro.jpeg" alt="Pedro" />
              </div>
              <div className="member-info">
            ...
            <div className="member-card">
              <div className="member-photo">
                <img src="/public/leticia.jpeg" alt="Letícia" />
              </div>
              <div className="member-info">
            ...
            <div className="member-card">
              <div className="member-photo">
                <img src="/public/wesley.jpg" alt="Wesley" />
              </div>
              <div className="member-info">
            ...
            <div className="member-card">
              <div className="member-photo">
                <img src="/public/larissa.jpg" alt="Larissa" />
              </div>
              <div className="member-info">
